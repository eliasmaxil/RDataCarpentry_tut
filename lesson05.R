...
# # Crear nueva "create = TRUE"
# my_db_file <- "data/portal-database-output.sqlite"
# my_db <- src_sqlite(my_db_file, create = TRUE) # Empty

# # Copiar datos a nueva DB
# copy_to(my_db, surveys)
# copy_to(my_db, plots)
# my_db

# Abrir, ver y cerrar nueva conneccion
# outputdb <- DBI::dbConnect(RSQLite::SQLite(), my_db_file)
# src_dbi(outputdb)
